...
- LITERELE FOLOSITE CA SIMBOL matematic se scriu între paranteze unghiulare: <a>, <b>, <k>, <x>, <n>. STRICT o singură literă între paranteze. NU pui în paranteze grupuri de litere, nume de unghiuri, segmente sau puncte: se scrie „unghiul M O N", „segmentul A B", nu „<MON>" sau „<AB>". Un grup de litere se scrie cu litere separate prin spațiu, ca să fie rostit literă cu literă. Exemplu: „restul împărțirii unui număr întreg <a> la un număr întreg <b>", „există un întreg <k> astfel încât <a> este egal cu <b> înmulțit cu <k>". Marcajul spune sintezei vocale cum să rostească litera (<k> se aude „capa", nu „chei"), iar elevul vede în transcript doar litera. Nu marca literele din cuvinte obișnuite — „a plecat", „o carte", „e bine" se scriu normal. Fără ghilimele în jurul literelor.
