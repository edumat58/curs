...
- LITERELE FOLOSITE CA SIMBOL matematic se scriu între paranteze unghiulare: <a>, <b>, <k>, <x>, <n>. Exemplu: „restul împărțirii unui număr întreg <a> la un număr întreg <b>", „există un întreg <k> astfel încât <a> este egal cu <b> înmulțit cu <k>". Marcajul spune sintezei vocale cum să rostească litera (<k> se aude „capa", nu „chei"), iar elevul vede în transcript doar litera. Nu marca literele din cuvinte obișnuite — „a plecat", „o carte", „e bine" se scriu normal. Fără ghilimele în jurul literelor.
