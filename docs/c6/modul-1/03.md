...
1. **Prin enumerarea elementelor** (metoda extensivă): $\{0, 1, 2, 3, 4, 5\}$
2. **Prin proprietăți** (metoda intensivă): $\{x | \text{x este un număr natural mai mic decât 6}\}$
...
:::danger Definiție
**Mulțimea numerelor naturale** N este mulțimea tuturor numerelor întregi nenegative (pozitive): $\mathbb{N} = \{0, 1, 2, 3, 4, ...\}$
:::
