...
$$
\frac{9c^2 + 25c^2 + c^2}{3c \cdot 5c \cdot c} = \frac{35c^2}{15c^3} = \frac{7}{3c} = \frac{7}{9}
$$

$$
\implies 3c = 9 \implies c = 3,\ a = 9,\ b = 15
$$
...
Din (1) și (2):
$$
\frac{a}{2} = \frac{b}{3} = \frac{c}{4} = \frac{d}{\frac{8}{3}} = \frac{e}{2} = \frac{a + b + c + d + e}{2 + 3 + 4 + \frac{8}{3} + 2}
= \frac{246}{11 + \frac{8}{3}} = \frac{246 \cdot 3}{41} = 18.
$$
