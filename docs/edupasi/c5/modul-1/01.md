...
import SursaCurs from '@site/src/components/SursaCurs';

<SursaCurs />

# C1s - Scrierea sub forma zecimală
...
:::tip Definiție
Numim **număr zecimal**, un număr ce se poate scrie sub forma unei fracții zecimale.

Acesta se poate scrie ca sumă dintre un **<HighlightText color="red">număr întreg</HighlightText>** 
:::
...
<Katex>
{String.raw`
37\,540{,}85 = 3 \times 10\,000 + \\[6pt]
7 \times 1\,000 + 5 \times 100 +\\[6pt] 4 \times 10 + 0 \times 1 + 8 \times 0{,}1 + 5 \times 0{,}01
`}
</Katex>
